...
export declare class SolidityParser extends Parser {
    ...
    static readonly RULE_usingDirective = 36;
    static readonly RULE_typeName = 37;
    static readonly RULE_elementaryTypeName = 38;
    static readonly RULE_functionTypeName = 39;
    static readonly RULE_variableDeclaration = 40;
    static readonly RULE_dataLocation = 41;
    static readonly RULE_expression = 42;
    static readonly RULE_assignOp = 43;
    static readonly RULE_tupleExpression = 44;
    static readonly RULE_inlineArrayExpression = 45;
    static readonly RULE_identifier = 46;
    static readonly RULE_literal = 47;
    static readonly RULE_booleanLiteral = 48;
    static readonly RULE_stringLiteral = 49;
    static readonly RULE_hexStringLiteral = 50;
    static readonly RULE_unicodeStringLiteral = 51;
    static readonly RULE_numberLiteral = 52;
    static readonly RULE_block = 53;
    static readonly RULE_uncheckedBlock = 54;
    static readonly RULE_statement = 55;
    static readonly RULE_simpleStatement = 56;
    static readonly RULE_ifStatement = 57;
    static readonly RULE_forStatement = 58;
    static readonly RULE_whileStatement = 59;
    static readonly RULE_doWhileStatement = 60;
    static readonly RULE_continueStatement = 61;
    static readonly RULE_breakStatement = 62;
    static readonly RULE_tryStatement = 63;
    static readonly RULE_catchClause = 64;
    static readonly RULE_returnStatement = 65;
    static readonly RULE_emitStatement = 66;
    static readonly RULE_revertStatement = 67;
    static readonly RULE_assemblyStatement = 68;
    static readonly RULE_assemblyFlags = 69;
    static readonly RULE_variableDeclarationList = 70;
    static readonly RULE_variableDeclarationTuple = 71;
    static readonly RULE_variableDeclarationStatement = 72;
    static readonly RULE_expressionStatement = 73;
    static readonly RULE_mappingType = 74;
    static readonly RULE_mappingKeyType = 75;
    static readonly RULE_yulStatement = 76;
    static readonly RULE_yulBlock = 77;
    static readonly RULE_yulVariableDeclaration = 78;
    static readonly RULE_yulAssignment = 79;
    static readonly RULE_yulIfStatement = 80;
    static readonly RULE_yulForStatement = 81;
    static readonly RULE_yulSwitchCase = 82;
    static readonly RULE_yulSwitchStatement = 83;
    static readonly RULE_yulFunctionDefinition = 84;
    static readonly RULE_yulPath = 85;
    static readonly RULE_yulFunctionCall = 86;
    static readonly RULE_yulBoolean = 87;
    static readonly RULE_yulLiteral = 88;
    static readonly RULE_yulExpression = 89;
